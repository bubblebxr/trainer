                ...
                <a-list-item key="item.name">
                    ...
                    <template #actions>
                      ...
                      <div style="margin-left: 300px">
                        ...
                        <router-link :to="{ name: 'about', params: { item: item }}" target="_blank">点击查看</router-link>
                      </div>
...
const fetchData = async () => {
    if (flag.value === 1) {
        ...
        try {
            ...
            places.value = data.data.getPlaces;
...
//点击查询
const search = () => {
    if (arrive_station.value === '' || arrive_date.value === '' || Ideparture_date === '') {
        ElMessage({
            message: '还有没填写的信息',
            type: 'error',
            plain: true,
